...
_tabversion   = '3.8'
_lextokens    = set(('WSTRING_LITERAL', 'ELSE', 'ARROW', 'LOR', 'ENUM', 'PERIOD', 'BREAK', 'WCHAR_CONST', 'PLUS', 'LONG', 'MOD', 'FLOAT_CONST', 'LPAREN', 'VOLATILE', 'TYPEID', 'RBRACKET', 'STRUCT', 'STATIC', 'RSHIFT', 'EQ', 'IF', 'ANDEQUAL', 'INLINE', 'TIMESEQUAL', 'CHAR_CONST', 'HEX_FLOAT_CONST', 'GOTO', 'TIMES', 'LSHIFTEQUAL', 'INT_CONST_OCT', 'WHILE', 'EQUALS', 'CASE', 'PLUSEQUAL', 'DIVEQUAL', 'OFFSETOF', 'SIZEOF', 'NOT', 'UNION', 'GT', 'FOR', 'COLON', 'LSHIFT', 'INT', 'INT_CONST_HEX', 'VOID', 'OREQUAL', 'INT_CONST_DEC', 'LNOT', 'DOUBLE', 'MODEQUAL', 'XOR', 'DIVIDE', 'CHAR', 'PLUSPLUS', 'AUTO', 'LBRACE', 'SHORT', 'EXTERN', 'SIGNED', 'MINUSMINUS', 'TYPEDEF', 'ID', 'OR', 'XOREQUAL', 'RSHIFTEQUAL', 'RETURN', 'COMMA', 'REGISTER', 'MINUS', 'LE', 'DO', 'STRING_LITERAL', 'RBRACE', 'LBRACKET', 'LT', 'RESTRICT', 'CONST', 'DEFAULT', 'SWITCH', 'NE', 'CONDOP', 'SEMI', 'PPHASH', '_COMPLEX', 'RPAREN', 'MINUSEQUAL', 'ELLIPSIS', 'AND', 'INT_CONST_BIN', 'UNSIGNED', 'FLOAT', 'LAND', 'GE', 'CONTINUE', '_BOOL'))
_lexreflags   = 0
_lexliterals  = ''
