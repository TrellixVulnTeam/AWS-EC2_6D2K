...
audit_format_signal_info = _audit.audit_format_signal_info
...
audit_rule_create_data = _audit.audit_rule_create_data

def audit_rule_init_data(rule: 'audit_rule_data') -> "void":
    return _audit.audit_rule_init_data(rule)
audit_rule_init_data = _audit.audit_rule_init_data
