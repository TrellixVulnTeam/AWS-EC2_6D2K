...
"x86_64-linux-thread-multi-4.18.0-240.el8.x86_64" or
	die "Errno architecture (x86_64-linux-thread-multi-4.18.0-240.el8.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
